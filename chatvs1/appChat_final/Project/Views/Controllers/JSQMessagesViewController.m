...
- (void)jsq_configureMessagesViewController
{
    ...
    self.inputToolbar.contentView.textView.placeHolder = @"jhcgfxgh";// Liem
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text {
    ...
    if([text isEqualToString:@"\n"]) {
        ...
        NSLog(@" message send:  %@ ", self.inputToolbar.contentView.textView.text);
        [self didPressSendButton:self.inputToolbar.contentView.rightBarButtonItem
                 withMessageText:[self jsq_currentlyComposedMessageText]
                        senderId:[self.collectionView.dataSource senderId]
               senderDisplayName:[self.collectionView.dataSource senderDisplayName]
                            date:[NSDate date]];
...
{
    NSLog(@"jsq_didReceiveKeyboardWillChangeFrameNotification ok ");
    NSDictionary *userInfo = [notification userInfo];

    CGRect keyboardEndFrame = [userInfo[UIKeyboardFrameEndUserInfoKey] CGRectValue];
    NSLog(@"keyboard width = %f ,\n keyboard height = %f ", keyboardEndFrame .size.width, keyboardEndFrame.size.height);
